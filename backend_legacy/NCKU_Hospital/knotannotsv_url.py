...
def knotannotsv1(request):
    if request.method == 'GET':
        newjobID='JbFovcaEsd'
        shell_script_path = "/miRTI/ssh_annotsv.py"
        perl_script_path = "/miRTI/knotannotsv/knotAnnotSV/knotAnnotSV.pl"
        annotSV_file = f"/annotsv/output1/{newjobID}.tsv"
        config_file = "/miRTI/knotannotsv/knotAnnotSV/config_AnnotSV.yaml"
