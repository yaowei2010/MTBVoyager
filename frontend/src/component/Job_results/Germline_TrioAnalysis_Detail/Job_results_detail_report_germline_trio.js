...
function Job_results_detail_report() {
  ...
  const baseCols = [
    ...
    { field: 'INH', headerName: 'INH', flex: 1, minWidth: 150 },
            ...
            <Paper sx={{ backgroundColor: 'lightgray', p: 2 }} elevation={8}>
              {jsonData ? (
                <>
                  <h2>
                    Panel Name :{' '}
                    {jsonData.gene_panel_list.GenePanelList[0].panelName}
                  </h2>
                  ...
                  <Collapse in={isPanelExpanded} timeout="auto" unmountOnExit>
                    <pre style={{ whiteSpace: 'pre-wrap' }}>
                      {jsonData.gene_panel_list.GenePanelList[0].genePanel.replace(
                        /\n/g,
                        ', '
                      )}
                    </pre>
